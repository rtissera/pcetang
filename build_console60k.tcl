...
# pcetang Phase 1: Tang Console 60K, TangCore-integrated (iosys_bl616), HuCard-only.
# First real gw_sh attempt for this repo -- see docs/ARCHITECTURE.md's status note.
# Run from the repo root: gw_sh build_console60k.tcl
...
add_file src/pcetang_console60k.vhd
add_file src/pcetang_console60k.cst
add_file src/pcetang_console60k.sdc

set_option -synthesis_tool gowinsynthesis
set_option -output_base_name pcetang_console60k
set_option -verilog_std sysv2017
set_option -vhdl_std vhd2008
set_option -top_module pcetang_console60k
