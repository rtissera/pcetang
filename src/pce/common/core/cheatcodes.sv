...
// Apr 21, 2019
//
// GOWIN FIX (NECTang, GPL-3.0-or-later on this port's own changes): `genie_ovr` and
// `genie_data` were implicit-typed output ports, both procedurally assigned inside
// `always_comb` below. Real gw_sh run failed with EX3900 "Procedural assignment to a
